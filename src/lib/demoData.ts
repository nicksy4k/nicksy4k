  ...
  return [
    {
      ...
      receipt_location: "",
      items: [
        { id: "d1-i1", item_name: "Weekly veg box", price: 12.5, quantity: 1, category: "Groceries" },
        { id: "d1-i2", item_name: "Chicken thighs", price: 6.4, quantity: 2, category: "Groceries" },
        { id: "d1-i3", item_name: "Sourdough", price: 3.2, quantity: 1, category: "Groceries" },
        { id: "d1-i4", item_name: "Cleaning spray", price: 4.1, quantity: 1, category: "Household" },
        { id: "d1-i5", item_name: "Ground coffee", price: 10.0, quantity: 1, category: "Groceries" },
      ],
      created_at: nowIso(),
    },
    {
      ...
      receipt_location: "",
      items: [
        { id: "d2-i1", item_name: "Family plan", price: 11.99, quantity: 1, category: "Subscriptions" },
      ],
      created_at: nowIso(),
    },
    {
      ...
      receipt_location: "",
      items: [
        { id: "d3-i1", item_name: "Wireless headphones", price: 249.0, quantity: 1, category: "Tech" },
      ],
    ...
    },
    {
      ...
      receipt_location: "",
      items: [
        { id: "d5-i1", item_name: "Cinema tickets", price: 12.0, quantity: 2, category: "Entertainment" },
      ],
      created_at: nowIso(),
    },
  ];
