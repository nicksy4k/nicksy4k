...
/**
 * Advance a commitment by its own cadence when one is recorded; otherwise
 * use the global cycle length. This keeps monthly/weekly commitments stable
 * when the account's income cycle is four-weekly.
 */
